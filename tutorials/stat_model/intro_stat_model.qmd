...
description: "Learn the model building, predicting, evaluating and plotting models in R"
date: "08/04/2022"
...
We can use the `summary()` function to summarise the model. For now, we will not worry about the summary details. Then, using the `{ggplot2}` package, we will plot the model using the `stat_smooth()` function.
