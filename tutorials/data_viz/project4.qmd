...
description: "Learn how to make publication ready plots and perform statistical tests using the ggpubr package"
date: "01/06/2022"
format: html
image: images/ggpubr.png
categories: [ggplot2, data visualization]
---

::: {layout-ncol="1"}
![Image by [Markus Spiske](https://unsplash.com/@markusspiske) on [Unsplash](https://unsplash.com)](https://images.unsplash.com/photo-1618044733300-9472054094ee?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1171&q=80){.preview-image}
:::
