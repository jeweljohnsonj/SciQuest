...
2.  Now got to [Notion integrations](https://www.notion.so/my-integrations) and click on 'New integration'. Give a suitable name (something like 'Notero integration' for ease of finding it) and select your work-space in Notion. You can keep the rest of the options in their default setting and then save it. You will then get your integration token.
