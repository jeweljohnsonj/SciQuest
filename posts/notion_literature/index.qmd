...
There is a reason why I said it's a one-time sync, so any modifications that you do for already existing files won't be reflected in Notion. But this can be easily fixed by assigning the existing papers to a temporary tag and then deleting it.
