...
Everyone please note that I am moving away from GitHub pages to Netifly to deploy my blog. Therefore please use the new [link](https://one-carat-blog.netlify.app/) to visit this blog. If you are using the old link (GitHub page link) : https://jeweljohnsonj.github.io/one-carat-blog/ then please move to the [new link](https://one-carat-blog.netlify.app/) as I will retire the GitHub page link in coming weeks. Thank you for your support.
:::
